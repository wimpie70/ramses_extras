...
FEATURE_DEFINITION = {
    ...
    "entity_mappings": {
        ...
        # Temporary override timer (minutes remaining)
        "remaining_mins_entity": "sensor.{device_id}_remaining_mins",
        ...
        "transport_state_entity": "binary_sensor.transport_state_{device_id}",
        # Bypass position
