...
async def test_register_bootstrap_adds_resource(card_registry):
    ...
    version = "1.2.3"
    expected_url = "/local/ramses_extras/helpers/main.js"
...
async def test_register_removes_legacy_resources(card_registry):
    ...
    # Bootstrap should be added (stable URL)
    assert "/local/ramses_extras/helpers/main.js" in urls
    # Legacy versioned should be removed
    assert f"/local/ramses_extras/v{version}/helpers/main.js" not in urls
...
async def test_register_idempotent(card_registry):
    ...
    version = "1.2.3"
    url = "/local/ramses_extras/helpers/main.js"
